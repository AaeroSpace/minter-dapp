const contractAddress = "0xB9B8A164B3ac880F59B4605490dAaEd237CB332a"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome To The IAMNATION Jacket Shop";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'This is simply the test site for the real project';
const h1_presale_coming_soon = "Jacket Drop Coming Soon";
